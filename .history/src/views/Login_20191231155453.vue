...
<div class="align-self-center">
    ...
    <article class="card-body">
        <a href="/registrar" class="float-right btn btn-outline-primary">Sign up</a>
        ...
        <p>
            ...
            <a @click="loginGoogle" href="" class="btn btn-block btn-outline-danger"> <i class="fab fa-google"></i> Login via Google</a>
        </p>
        <hr>
...
export default {
    ...
    methods: {
        ...
        loginGoogle: function(){
            ...
            firebase.auth().signInWithPopup(firebase.auth.GoogleAuthProvider).then(
                (result) => {
                alert('Paasou: '+result.user)
                },
                (error) => {
                    alert('Não foi possivel logar. '+ error.message)
                });
